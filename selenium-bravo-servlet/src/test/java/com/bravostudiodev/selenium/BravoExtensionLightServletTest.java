...
public class BravoExtensionLightServletTest {
    ...
    public void setUp() throws Exception {
        basePath = "/" + BravoExtensionLightServlet.class.getSimpleName() + "/";
        sikuliServer = startServerForServlet(new BravoExtensionLightServlet(), basePath + "*");
